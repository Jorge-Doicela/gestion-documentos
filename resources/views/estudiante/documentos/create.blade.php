...
@section('content')
    <div class="max-w-2xl mx-auto p-4">
        ...
        <a href="{{ route('estudiante.documentos.index') }}" class="text-blue-600 underline mb-4 inline-block">⬅️ Volver a mis
            documentos</a>
        ...
        <form action="{{ route('estudiante.documentos.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                <label for="tipo_documento_id" class="block font-medium text-sm text-gray-700">Tipo de documento</label>
            ...
            <div>
                <label for="archivo" class="block font-medium text-sm text-gray-700">Archivo PDF</label>
                ...
                <p class="text-sm text-gray-500 mt-1">Tamaño máximo permitido:
                    <strong>{{ number_format($tamanoMaximoMB, 2) }} MB</strong>
                </p>
            </div>
